...
const descriptions = {
    toxic: {
        ...
        modifiers: {
            ...
            TheBaus:
                'Your 1v5 attempts are just elaborate inting with extra steps.',
            cryBabyAdc: 'Toxic and emotional - a true ADC main.',
            boosted:
                'You blame teammates while being carried harder than a shopping cart.',
            theSmurf:
                "Your 'educational' smurfing comes with bonus verbal abuse.",
            strategic:
    ...
    TheBaus: {
        ...
        modifiers: {
            ...
            boosted:
                "Even your duo can't explain how some of these deaths work",
            cryBabyAdc:
            ...
            strategic:
                "Your 'strategy' is just running it down with extra steps",
            serious:
    ...
    cryBabyAdc: {
        ...
        modifiers: {
            ...
            serious:
                'You take every death as a personal insult from Riot Games',
        },
    ...
    theSmurf: {
        ...
        modifiers: {
            ...
            strategic:
                "Your 'coaching' consists of spamming pings and typing '?'",
            serious:
    ...
    strategic: {
        ...
        modifiers: {
            ...
            cryBabyAdc:
                'You ping missing 15 times then tilt when no one rotates',
            theSmurf:
...
const relationships = {
    toxic: {
        ...
        boosted:
            'You flame others while being carried harder than a shopping cart',
    ...
    theSmurf: {
        ...
        TheBaus:
            "Your plays make people report you whether you're smurfing or not",
    ...
    strategic: {
        ...
        boosted:
            "Your 'strategic genius' disappears the moment teamfights start",
        TheBaus:
...
function getMatchingPersonality(userId) {
    ...
    const personalityType = matchTypes(
        getHighestKey(
            Object.entries(archetypes).reduce((acc, [key, value]) => {
                acc[key] = value
                return acc
            }, {})
        )
    ...
    fetch('/getMatchingPersonalityUser', {
        ...
        .then((data) => {
            const matchingUserAvatar =
                document.getElementById('matchingUserAvatar')
...
function drawChart(data) {
    ...
    svg.selectAll('.axis')
        ...
        .attr(
            'x2',
            (d, i) => radius * Math.sin((i * Math.PI * 2) / data.length)
        )
        .attr(
            'y2',
            (d, i) => -radius * Math.cos((i * Math.PI * 2) / data.length)
        )
        .attr('stroke', '#ddd')
    ...
    fetch('/getPersonalityTestResult', {
        ...
        .then((data) => {
            if (data.success) {
                ...
                console.error('Error fetching old result:', data.message)
                fetchQuestions()
            }
        })
