document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("validate-actions").addEventListener("click", () => {
        saveAllSocials();
    });
    ...
    function saveAllSocials(type) {
        ...
        const socialData = {
            ...
            discord: sanitizeValue(socialInputs.discord ? socialInputs.discord.value : getCurrentSocialData('discord')),
            twitter: sanitizeValue(socialInputs.twitter ? socialInputs.twitter.value : getCurrentSocialData('twitter')),
            instagram: sanitizeValue(socialInputs.instagram ? socialInputs.instagram.value : getCurrentSocialData('instagram')),
            twitch: sanitizeValue(socialInputs.twitch ? socialInputs.twitch.value : getCurrentSocialData('twitch')),
            bluesky: sanitizeValue(socialInputs.bluesky ? socialInputs.bluesky.value : getCurrentSocialData('bluesky'))
        };
    ...
    function getCurrentSocialData(platform) {
        const socialElement = document.querySelector(`.social-container-column[data-platform="${platform}"] p`);
