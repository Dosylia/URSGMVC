...
class CreateAccount{
    ...
    set username(newUsername) {
        ...
        {
            let span = new ErrorSpan(newUsername.id,"Must respect format (3 to 20 characters, no space allowed)");
            span.displaySpan();
            this._usernameError = true;   
        }
        else 
    ...
    set age(newAge) {
        ...
        {
            let span = new ErrorSpan(newAge.id,"Your age does not respect our rules");
            span.displaySpan();
            this._ageError = true;   
        }
